...
function addWatermark() {
    // Watermark disabled by admin request
...
function terminateExam(reason) {
    ...
    returnBtn.style.cssText = `
            ...
            pointer-events: auto;
        `;
    returnBtn.onmouseover = () => returnBtn.style.background = "rgba(255, 255, 255, 0.3)";
    returnBtn.onmouseout = () => returnBtn.style.background = "rgba(255, 255, 255, 0.2)";
    returnBtn.onclick = () => location.reload();

    // إضافة الزر بعد 3 ثواني
    setTimeout(() => {
